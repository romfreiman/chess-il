# Requirements Archive: v1.1 Club Player Search & Export
...
- [x] **EXPORT-01**: User can export selected players to a CSV file (name, ID, rating, club, age, rank)
- [x] **EXPORT-02**: User can export all search results (not just selected) to CSV
- [x] **EXPORT-03**: CSV file opens correctly in Excel with Hebrew characters (UTF-8 BOM encoding)
